...
<p>&nbsp;</p>
 ...
 <table width="200" border="0" align="right">
  ...
  <div >            
 <h3 class="table-warning" style="margin-left:240px;width:300px;padding:10px;border-color:#000;border-style:solid;border-radius:10px"> ประเภทกระทู้ : บทความ</h3>
  </div>
<br>
  ...
  <br>
	<div  style="margin-left:260px" class="input-group-prepend"> <span style="color:#C60" class="input-group-text" ><b>รายละเอียด</b></span> </div>
  ...
  #000"" name="contend"  placeholder="พิมพ์รายละเอียด"></textarea>
