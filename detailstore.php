...
ini_set("mongo.native_long", 0);
  ...
  foreach($cursor as $log){
	...
	$collection->insert(array("_id"=>$pid,"วันที่"=>date("d-m-Y"),"เวลา"=>date("H:i"),"doc_type"=>"ขายของ","name"=>$_POST['contend'],
	"สินค้า"=>$_POST['product'],"ราคา"=>$_POST['price'],
...
<form method="post">
  <div >            
 <h3 class="table-warning" style="margin-left:240px;width:300px;padding:10px;border-color:#000;border-style:solid;border-radius:10px"> ประเภทกระทู้ : ขายของ</h3>
  </div>
<br>
...
<table width="1000" border="0" align="center">
    <tr>
      <td><div  class="input-group mb-3">
        <div  class="input-group-prepend "><b class="input-group-text">สินค้า</b></div>
        <input style="margin-left:50px;width:500px;" type="text" name="product"  >
      </div></td>
    </tr>
  </table>
  <p><br>
  ...
  <table width="1000" border="0" align="center">
    <tr>
      <td><div class="input-group mb-3">
        <div class="input-group-prepend"><b class="input-group-text">ราคา</b></div>
        <input style="margin-left:50px;width:200px;" type="text" name="price"   >
      </div></td>
    </tr>
  </table>
  <p><br>
